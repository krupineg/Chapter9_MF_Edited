...
//
//        // get the time stamp
//        THROW_ON_FAIL( hr = m_sampleQueue.GetHead()->GetSampleTime(pTimestamp) );
//    }
//    while(false);
//
//    return hr;
...
//        THROW_ON_FAIL( hr = m_sampleQueue.GetHead()->GetTotalLength(pLength) );
//    }
//    while(false);
//
//    return hr;
...
//        THROW_ON_FAIL( hr = m_sampleQueue.GetHead()->ConvertToContiguousBuffer(&pMediaBuffer) );
//        BREAK_ON_FAIL(hr);
//
